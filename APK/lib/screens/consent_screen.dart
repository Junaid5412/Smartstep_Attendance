              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _point(
                      Icons.phone_android,
                      'Recording continues even when the app is closed or not in use',
                      'SST Attendance collects location data to verify that you are within '
                          'your assigned work area and to record duty routes during your scheduled '
                          'shift even when the app is closed or not in use. While tracking is '
                          'running, an "on duty" notification is displayed so you can always tell. '
                          'Android requires you to choose "Allow all the time" for location.',
                    ),
                    _point(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Text(
                            'Your location is used strictly for enterprise attendance and work '
                            'verification. It is never sold, marketed, or shared with third parties.',
                          ...
                          InkWell(
                            ...
                            child: const Text(
                              'Read our full Privacy Policy & Data Rights →',
                              style: TextStyle(
                                fontSize: 12.5,
